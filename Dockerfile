...
RUN apt-get install -y -u apt-utils unzip apache2 memcached mysql-client php5 php5-dev php5-mysql php-pear nodejs nano upstart wget cron php-soap php5-intl php-gettext php5-memcache php5-curl php5-mysql php5-tidy php5-imagick php5-geoip curl
...
RUN mv /tmp/ioncube_install/ioncube/ioncube_loader_lin_5.5.so /usr/lib/php5/20121212
